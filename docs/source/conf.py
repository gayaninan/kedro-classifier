...
# iris_classifier documentation build
...
from iris_classifier import __version__ as release
...
# Theme options are theme-specific and customis the look and feel of a theme
...
htmlhelp_basename = "iris_classifierdoc"
...
texinfo_documents = [
    (
        ...
        author,
        "iris_classifier",
        "Project iris_classifier codebase.",
        "Nearest-Neighbour",
    )
]
